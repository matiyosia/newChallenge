    ...
    <div class="cards" >
      <div class="content-card-flex">
        <div>
          <v-avatar
            :icon="card.icon"
            style="max-width: 38px; max-height: 40px; background: #91CC75; border-radius: 50%; color: white; align-items: center; margin-left: 5px;"
          ></v-avatar>
        </div>
      ...
      <div class="content-flex" style="display: flex; justify-content: space-between;">
